        ...
        <div className='w-full relative overflow-x-hidden ' > 
            <div className=' z-50 px-6 lg:px-20 bg-[#1F1610]' >
                ...
                <div className=' w-full flex flex-col lg:pt-8 pt-16 pb-20 justify-center items-center text-white ' > 
                    ...
                    <p className=' font-CircularStd-Medium w-96 mt-2 text-center ' >For that affordable yet professional shot today. See the direction to our studio or call us on the number.</p>
                </div> 
            </div> 
            <div style={{background: 'radial-gradient(50% 50% at 50% 50%, #574130 0%, #1F1610 100%)'}} className='w-full flex flex-col justify-center items-center text-white lg:px-0 px-6' >
                <div className='w-full lg:flex-row h-full flex-col flex justify-center text-white' >
                    <a href='http://wa.link/9xzsdb' className='lg:mx-6 h- cursor-pointer flex flex-col items-center ' >
                        ...
                        <p className=' lg:text-base font-CircularStd-Medium mt-2' >+234 706 817 2124</p>
                    </a>
                    <div className='lg:mx-6 text-sm cursor-pointer flex  flex-col items-center ' > 
                        ...
                        <p className=' text-sm lg:text-base font-CircularStd-Medium mt-2' >courage@ncouragestudios.com</p>
                    </div>
                    <a href='https://www.google.com/search?q=ncourage%20photography&sxsrf=ALiCzsZHP_ejzj0uOTOEKeYgd4ZzElSixQ:1656185603973&source=hp&ei=_2K3Yq2MLo-oa5jcsYgK&iflsig=AJiK0e8AAAAAYrdxD8tgvSTnUFm8wLqGAsTzGPwAiSXH&oq=ncou&gs_lcp=_C5IBBzItMy4xLjGYAQCgAQE&sclient=gws-wiz&tbs=lf:1,lf_ui:14&tbm=lcl&rflfq=1&num=10&rldimm=9012098400779300777&lqi=ChRuY291cmFnZSBwaG90b2dyYXBoeUizqq2durKAgAhaHhAAEAEYABgBIhRuY291cmFnZSBwaG90b2dyYXBoeZIBEnBob3RvZ3JhcGh5X3N0dWRpbw&ved=2ahUKEwjugu2UrMn4AhXq7rsIHau4CSgQvS56BAgEEAE&sa=X&rlst=f#' className='lg:mx-6 cursor-pointer flex  flex-col items-center ' > 
                        <svg className=' w-20 h-20 ' viewBox="0 0 122 122" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="61" cy="61" r="60.5" fill="white" fill-opacity="0.08" stroke="white"/>
                        ...
                        <p className=' text-sm lg:text-base font-CircularStd-Medium mt-2 text-center w-48' >3a Ehimen Street, Adesuwa Rd, Upper, Benin City</p>
                    </a>
                </div>
