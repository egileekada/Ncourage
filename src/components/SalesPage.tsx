    ...
    return (
        <div className='w-full overflow-hidden' >
            ...
            <div className='w-full h-auto absolute top-0' >
                ...
                <div className=' w-full h-screen  lg:flex-row flex-col-reverse py-10 lg:py-0 px-6 lg:px-0 lg:p-20 items-center backdrop-blur-2xl flex bg-[#2C241F7A]' >
                    ...
                    <div className='ml-auto mr-12' >
                        ...
                        <p className=' mt-4 w-96 text-[#FFFFFFCC] font-CircularStd-Medium ' >Lorem ipsum dolor sit amet, consecteturLorem ipsum dolor sit amet, consectetur</p>
                    
                        <div className='flex lg:mb-0 mb-16 lg:justify-start mt-10' >
                            <div className='lg:px-6 lg:pr-0 pr-4' >
                                <p className=' font-CircularStd-Medium text-4xl text-[#EDB388] ' >934</p>
                                <p className=' mt-1 w-28 text-sm text-[#E7DDD5] font-CircularStd-Medium ' >Finished Photosessions</p>
                            </div>
                            <div className='lg:px-6 px-4 h-16 border-l border-r border-[#7D614C] ' >
                                <p className=' font-CircularStd-Medium text-4xl text-[#EDB388] ' >2,934</p>
                                <p className=' mt-1 w-16 text-sm text-[#E7DDD5] font-CircularStd-Medium ' >Studio Sessions</p>
                            </div>
                            <div className='lg:px-6 lg:pl-0 pl-4' >
                                <p className=' font-CircularStd-Medium text-4xl text-[#EDB388] ' >1,234</p>
